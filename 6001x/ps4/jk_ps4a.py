...
def getWordScore(word, n):
    ...
    # ps doesn't say what to do in this case
    # if len(word) > n:
    #   return 0
    
    score = 0

    for letter in word:  # test for lenght n
        score += SCRABBLE_LETTER_VALUES[letter]
        #print score, SCRABBLE_LETTER_VALUES[letter]
...
def updateHand(hand, word):
    ...
    for letter in word:
        if letter in new_hand:
            removeOneLetter(new_hand,letter)
    #print "Final Hand: ",new_hand
    return new_hand


        
def removeOneLetter(hand,letter):
    """
    Convenience method to remove a letter from a hand backed by a dictionary.
    On entry, hand is a Dictionary of letter -> int pairs where int >0. It will be mutated!
