...
class edx(object):
    ...
    def setGrade(self, grade, course="6.01x"):
        ...
        for crse in self.myCourses:
            #print 'try course ',crse.courseName, 'looking for ', course
            if crse.courseName == course:
                crse.setGrade(grade)
                #print "set grade: ",crse.courseName, crse.getGrade()
                break
